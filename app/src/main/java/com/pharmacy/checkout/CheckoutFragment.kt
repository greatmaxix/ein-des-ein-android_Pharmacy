...
import com.pharmacy.checkout.CheckoutFragmentDirections.Companion.actionCheckoutToPromoCodeDialog
import com.pharmacy.checkout.adapter.CheckoutProductsAdapter
import com.pharmacy.checkout.dialog.PromoCodeDialogFragment
import com.pharmacy.checkout.dialog.PromoCodeDialogFragment.Companion.PROMO_CODE_REQUEST_KEY
...
class CheckoutFragment(private val viewModel: CheckoutViewModel) : BaseMVVMFragment(R.layout.fragment_checkout), View.OnClickListener {
    ...
    private fun setPharmacyInfo() = with(args.cartItem) {
        pharmacyAddressCheckout.pharmacy = com.pharmacy.ui.PharmacyAddressOrder.PharmacyInfo(logo.url, name, location.address)
    }
