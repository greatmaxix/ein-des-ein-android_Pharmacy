...
import com.pharmacy.data.remote.DummyData.paymentMethod
import com.pharmacy.model.order.Order
import com.pharmacy.model.order.OrderStatus
import com.pharmacy.ui.OrderSteps
...
class OrderDetailsFragment(private val viewModel: OrderDetailsViewModel) : BaseMVVMFragment(R.layout.fragment_order_details) {
    ...
    private fun updateOrderInfo(order: Order) {
        ...
        with(args.order.pharmacy) { pharmacyAddressOrder.pharmacy = com.pharmacy.ui.PharmacyAddressOrder.PharmacyInfo(logo.url, name, location.address) }
